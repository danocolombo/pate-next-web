...
import styles from '/styles/jss/nextjs-material-kit-pro/pages/componentsSections/contentAreas.js';
                        ...
                        <div>
                                ...
                                body={
                                    <span>
                                        <p>
                                            ...
                                            {"'"}m so proud of @LifeOfDesiigner
                                            #1 song in the country. Panda! Don
                                            {"'"}t be scared of the truth
                                            because we need to restart the human
                                            foundation in truth I stand with the
                                            most humility. We are so blessed!
                                        </p>
                                        <p>
                                            All praises and blessings to the
                                            families of people who never gave up
                                            on dreams. Don{"'"}t forget, You
                                            {"'"}re Awesome!
                                        </p>
                                    </span>
                                }
                            ...
                            <Media
                                ...
                                body={
                                    <span>
                                        <p>
                                            Hello guys, nice to have you on the
                                            platform! There will be a lot of
                                            great stuff coming soon. We will
                                ...
                                innerMedias={[
                                    <Media
                                        ...
                                        body={
                                            <span>
                                                <p>
                                                    Hello guys, nice to have you
                                                    on the platform! There will
                                                    be a lot of great stuff
                                                    coming soon. We will keep
                                                    you posted for the latest
                                                    news.
                                                </p>
                                                <p>
                                                    Don{"'"}t forget, You{"'"}re
